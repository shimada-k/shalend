...
#define DATA_LINE_MAX	160	/* DATA_LINE buffer size */
#define AXIS_LINE_MAX	64
#define PATH_MAX		64

#define MAX_DOMAIN_LV	2

#define MAX_RECORD	100	/* up to 1000 second */
...
//MC_DOM__BUSIEST_GROUP_CAPACITY,
	...
	LB_COUNT_MC,
	MAX_PARAM,
	DIVIDER = LB_COUNT_SMT	/* DIVIDER以下はsheram.c(カーネルモジュール)が出力するものではないもの */
};
